        ...
        bodyMeasurements: [
          {
            ...
            measurements: [
              ...
              new Measurement(
                "neck",
                "0",
                this.registerDetailsForm.controls.extended.value.neck
              ),
              new Measurement(
                "shoulder",
                "0",
                this.registerDetailsForm.controls.extended.value.shoulder
              ),
              new Measurement(
                "waist",
                "0",
                this.registerDetailsForm.controls.extended.value.waist
              ),
              new Measurement(
                "hips",
                "0",
                this.registerDetailsForm.controls.extended.value.hips
              ),
              new Measurement(
                "thigh",
                "0",
              ...
              new Measurement(
                "chest",
                "0",
                this.registerDetailsForm.controls.extended.value.chest
              ),
              new Measurement(
                "forearm",
                "0",
                this.registerDetailsForm.controls.extended.value.forearm
              ),
              new Measurement(
                "calf",
                "0",
                this.registerDetailsForm.controls.extended.value.calf
              ),
              new Measurement(
                "ankle",
                "0",
                this.registerDetailsForm.controls.extended.value.ankle
              )
            ]
          }
        ]
